...
public class GasController {
    ...
    public ResponseEntity<String> getNearbyStations(
        ...
        String apiUrl = String.format(
                "https://www.opinet.co.kr/api/aroundAll.do?code=F241119462&x=%f&y=%f&radius=%d&sort=%d&prodcd=%s&out=json",
    ...
    public ResponseEntity<String> getStationDetails(@RequestParam String id) {
        String apiUrl = String.format(
            "https://www.opinet.co.kr/api/detailById.do?code=F241119462&id=%s&out=json", id
        );
